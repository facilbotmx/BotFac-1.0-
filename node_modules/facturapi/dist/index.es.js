class se {
   ...
   */
  create(t) {
    return this.client.post("/customers", { body: t });
  }
  /**
   ...
   */
  update(t, n) {
    return this.client.put("/customers/" + t, { body: n });
  }
  /**
...
const ce = "https://www.facturapi.io/v2", le = "https://www.facturapi.io/v1", j = "v2";
var V;
...
var P = { exports: {} };
(function(e, t) {
  var n = typeof globalThis < "u" && globalThis || typeof self < "u" && self || typeof M < "u" && M, a = function() {
    function u() {
  ...
  (function(u) {
    (function(l) {
      var h = typeof u < "u" && u || typeof self < "u" && self || typeof h < "u" && h, E = {
      ...
      d.prototype.append = function(r, i) {
        ...
        return r = S(r), this.has(r) ? this.map[r] : null;
      }, d.prototype.has = function(r) {
        return this.map.hasOwnProperty(S(r));
      ...
      function $(r) {
        for (var i = new Uint8Array(r), s = new Array(i.length), c = 0; c < i.length; c++)
      ...
      function te(r) {
        ...
        return r.trim().split("&").forEach(function(s) {
          if (s) {
            var c = s.split("="), f = c.shift().replace(/\+/g, " "), o = c.join("=").replace(/\+/g, " ");
            i.append(decodeURIComponent(f), decodeURIComponent(o));
          }
        }), i;
      }
      function re(r) {
        var i = new d(), s = r.replace(/\r?\n[\t ]+/g, " ");
        return s.split("\r").map(function(c) {
          return c.indexOf(`
`) === 0 ? c.substr(1, c.length) : c;
        }).forEach(function(c) {
          var f = c.split(":"), o = f.shift().trim();
          if (o) {
            var R = f.join(":").trim();
            i.append(o, R);
          }
      ...
      U.call(_.prototype), _.prototype.clone = function() {
        ...
        var r = new _(null, { status: 0, statusText: "" });
        return r.type = "error", r;
      };
      var ie = [301, 302, 303, 307, 308];
      _.redirect = function(r, i) {
        if (ie.indexOf(i) === -1)
          throw new RangeError("Invalid status code");
        return new _(null, { status: i, headers: { location: r } });
      ...
      function v(r, i) {
        return new Promise(function(s, c) {
          ...
          if (f.signal && f.signal.aborted)
            return c(new l.DOMException("Aborted", "AbortError"));
          ...
          o.onload = function() {
            var p = {
              ...
              headers: re(o.getAllResponseHeaders() || "")
            };
          ...
          function ne(p) {
            try {
              return p === "" && h.location.href ? h.location.href : p;
            } catch {
              return p;
            }
          }
          o.open(f.method, ne(f.url), !0), f.credentials === "include" ? o.withCredentials = !0 : f.credentials === "omit" && (o.withCredentials = !1), "responseType" in o && (E.blob ? o.responseType = "blob" : E.arrayBuffer && f.headers.get("Content-Type") && f.headers.get("Content-Type").indexOf("application/octet-stream") !== -1 && (o.responseType = "arraybuffer")), i && typeof i.headers == "object" && !(i.headers instanceof d) ? Object.getOwnPropertyNames(i.headers).forEach(function(p) {
            o.setRequestHeader(p, y(i.headers[p]));
          }) : f.headers.forEach(function(p, D) {
            o.setRequestHeader(D, p);
          }), f.signal && (f.signal.addEventListener("abort", R), o.onreadystatechange = function() {
            o.readyState === 4 && f.signal.removeEventListener("abort", R);
          }), o.send(typeof f._bodyInit > "u" ? null : f._bodyInit);
        });
      }
      return v.polyfill = !0, h.fetch || (h.fetch = v, h.Headers = d, h.Request = A, h.Response = _), l.Headers = d, l.Request = A, l.Response = _, l.fetch = v, l;
    })({});
...
const _e = (e, t = j) => {
  const n = t === "v1" ? le : ce, a = {
    Authorization: `Basic ${pe(e + ":")}`,
    "Content-Type": "application/json"
  };
  return {
    async request(u, l) {
      const { params: h, body: E, formData: b, ...T } = l || {}, g = h ? "?" + new URLSearchParams(h).toString() : "", S = b && I ? {
        ...a,
        ...b.getHeaders()
      } : a, y = {
        ...T,
        headers: S,
        body: b || (E ? JSON.stringify(E) : void 0)
      }, N = await he(n + u + g, y);
      return Ee(N);
    },
    get(u, l) {
      return this.request(u, { method: "GET", ...l });
    },
    post(u, l) {
      return this.request(u, { method: "POST", ...l });
    },
    put(u, l) {
      return this.request(u, { method: "PUT", ...l });
    },
    delete(u, l) {
      return this.request(u, { method: "DELETE", ...l });
    }
  };
};
class Oe {
   ...
   */
  uploadLogo(t, n) {
    const a = new (I ? L : FormData)();
    return I ? a.append("file", n, {
      filename: "file",
      contentType: "application/octet-stream"
    }) : a.append("file", n, "file"), this.client.put("/organizations/" + t + "/logo", { formData: a });
  }
  /**
   ...
   * @returns Organization object
   */
  uploadCertificate(t, n, a, O) {
    const u = new (I ? L : FormData)();
    return I ? u.append("cer", n, {
      filename: "cer.cer",
      contentType: "application/octet-stream"
    }) : u.append("cer", n, "cer.cer"), I ? u.append("key", a, {
      filename: "key.key",
      contentType: "application/octet-stream"
    }) : u.append("key", a, "key.key"), u.append("password", O), this.client.put("/organizations/" + t + "/certificate", {
      formData: u
    });
  }
  /**
...
class Be {
  ...
  constructor(t, n = {}) {
    if (n.apiVersion) {
      ...
      this.apiVersion = j;
    const a = _e(t, this.apiVersion);
    this.customers = new se(a), this.products = new oe(a), this.invoices = new ae(a), this.organizations = new Oe(a), this.catalogs = new Ae(a), this.receipts = new Ie(a), this.retentions = new Se(a), this.tools = new ye(a), this.webhooks = new be(a);
  }
}
export {
